...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 11 00:19:23 2017
...
def sub(result):
    for i in range(1,len(result)):
        if result.Symbol[i] == 'nan':
            result.Symbol[i] = result.Symbol[i-1]

        elif 'http://www.marketwatch.com/videovideo/' in result.Symbol[i]:
            result.Symbol[i] = result.Symbol[i-1]
...
#     #print tokenized[4][2]
#
#     try: #PROBLEM: accessing list of list, not individual words
#         for i in tokenized:
#             #print ('individual words',i)
#             print( type(i))
...
result = pd.read_json('/Users/Kirsteenng/tutorial/tutorial/spiders/reuters_article.json').astype(str)
#for market watch: result = result.rename(index=str, columns={"Name": "Symbol"})
...
#result.to_csv('/Users/Kirsteenng/Desktop/NASDAQ/testresultCNBC.csv')
